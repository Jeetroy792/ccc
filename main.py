...
bot = Client("my_bot", api_id=API_ID, api_hash=API_HASH, bot_token=BOT_TOKEN, in_memory=True, ipv6=False)
...
async def message_handler(bot: Client, m: Message):
#    try:
